...
const Navbar = () => {
  return (
    <div className="max-w-7xl m-auto flex justify-between items-center mt-5 max-[875px]:mt-[9px] px-5 max-sm:px-4 max-lg:text-sm">
      <div className="flex items-center">
        <div className="-mt-7 max-[875px]:mt-0 flex items-center ">
          <HumMenu />
        ...
        <div>
          ...
          <div className="flex gap-3 justify-end sm:hidden">
